    ...
    test('single spec', () => {
      ...
      expect(result['aaron.testing.d.ts']).toEqual(
        multiline(
          ...
          '      updateMany(query: Aaron.Testing.MyTable.UpdateQuery): Promise<Aaron.Testing.MyTable.QueryResults>;',
          '      updateOne(query: Aaron.Testing.MyTable.UpdateQuery): Promise<Aaron.Testing.MyTable.QueryResult>;',
    ...
    test('multiple spec', () => {
      ...
      expect(result['default.d.ts']).toEqual(
        multiline(
          ...
          '    aaron: Aaron;',
          '    OtherTable: {',
          '      count(query: OtherTable.CountQuery): Promise<OtherTable.CountResult>;',
          ...
          '      updateMany(query: OtherTable.UpdateQuery): Promise<OtherTable.QueryResults>;',
          '      updateOne(query: OtherTable.UpdateQuery): Promise<OtherTable.QueryResult>;',
