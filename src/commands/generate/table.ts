...
const printTableInterface = (table: TableSpecification | string): string => {
  ...
  return [
    ...
    `${_ws}updateMany(query: ${formattedName}.UpdateManyQuery): Promise<${formattedName}.QueryResults>;`,
    `${_ws}updateOne(query: ${formattedName}.UpdateOneQuery): Promise<${formattedName}.QueryResult>;`,
